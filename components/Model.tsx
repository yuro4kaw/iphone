...
import { yellowImg } from "@/constants/exports";
...
const Model = () => {
  ...
  const [sectionElement, setSectionElement] = useState<HTMLElement | undefined>(
    undefined
  );
    ...
    <section className="common-padding select-none" id="section">
      <div className="screen-max-width">
        ...
        <div className="flex flex-col items-center mt-5">
          <div className="w-full h-[75vh] md:h-[90vh] overflow-hidden relative flex">
            <ModelView
              index={1}
              groupRef={small}
              gsapType="view1"
