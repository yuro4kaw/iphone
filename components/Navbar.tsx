  ...
  return (
    <header className="w-full py-5 sm:px-10 px-5 flex justify-between items-center sticky top-0 bg-transparent backdrop-blur-md z-10">
      <nav className="flex w-full screen-max-width">
        <Image className="cursor-pointer" src={appleImg} alt="Apple" width={14} height={18} />
        ...
        <div className="flex items-baseline gap-7 max-sm:justify-end max-sm:flex-1">
          <Image className="cursor-pointer" src={searchImg} alt="search" width={18} height={18} />
          <Image className="cursor-pointer" src={bagImg} alt="bag" width={18} height={18} />
        </div>
      </nav>
    </header>
  );
